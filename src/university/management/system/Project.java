...
public class Project extends JFrame implements ActionListener {
    public Project()
    {
        ...
        Image i3=ic.getImage().getScaledInstance(1700,770,Image.SCALE_DEFAULT);         // 1950,950
        ...
        m1.setMnemonic('A');
        m1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_D,ActionEvent.CTRL_MASK));   // ctrl+d is the key
        ...
        m2.setMnemonic('B');
        m2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_M,ActionEvent.CTRL_MASK));     // ctrl +m is the key
        ...
        master.add(m1);       /* adding menu items to menu item */
        master.add(m2);
        ...
        mb.add(master);    // adding menu item to menu bar //
        mb.add(master);
        mb.add(user);
        mb.add(attendance);
