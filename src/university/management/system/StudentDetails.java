	...
	public void actionPerformed(ActionEvent ae) {
        ...
        if(ae.getSource() == b1){
            try{
                ...
                // deleting all the data of that roll no from all tables
               String q1="DELETE FROM subject where rollno = '"+a+"'";
              c1.s.executeUpdate(q1);
              String q2="DELETE FROM marks where rollno = '"+a+"'";
              c1.s.executeUpdate(q2);
              String q3="DELETE FROM attendance_student where rollno = '"+a+"'";
              c1.s.executeUpdate(q3);
              String q4="DELETE FROM fee where rollno = '"+a+"'";
